...
- (id) init {
    ...
    if ((self = [super initWithWindowNibName:@"SpikeController"]) != Nil) {
        [self setWindowFrameAutosaveName:@"SpikeController"];
...
// because setScaleFactor uses that
    ...
    defaultZoom = [[NSUserDefaults standardUserDefaults] integerForKey:spikeWindowZoomKey];
    ...
    if ([[NSUserDefaults standardUserDefaults] boolForKey:spikeWindowVisibleKey]) {
