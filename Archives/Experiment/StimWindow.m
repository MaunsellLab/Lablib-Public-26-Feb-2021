...
// Set up the calibration, including the offset then present the stimulus sequence
    ...
    [gabor setSPhaseDeg:[[NSUserDefaults standardUserDefaults] floatForKey:spatialPhaseDegKey]];
...
// Create and initialize a gabor stimulus
	...
	gaborKeys = [NSArray arrayWithObjects:azimuthDegKey, elevationDegKey, kdlPhiDegKey, kdlThetaDegKey, 
						orientationDegKey, radiusDegKey, sigmaDegKey, spatialFreqCPDKey, spatialPhaseDegKey,
						temporalFreqHzKey, nil];
