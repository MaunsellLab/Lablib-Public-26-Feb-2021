...
NSString *VTXTAutosaveKey = @"VTXTAutosave";

@implementation VTXTController
...
- (id)init {
    ...
    if ((self = [super initWithWindowNibName:@"VTXTController"]) != nil) {
 		[self setShouldCascadeWindows:NO];
        [self setWindowFrameAutosaveName:VTXTAutosaveKey];
...
// setting the maximum zoom size when the scale changes.
	...
	[[self window] setFrameUsingName:VTXTAutosaveKey];			// Needed when opened a second time
