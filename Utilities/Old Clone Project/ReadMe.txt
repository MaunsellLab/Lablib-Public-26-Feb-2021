...
Clone project will make a copy of an existing Lablib plugin in which the prefixes have been changed.  This is useful when you want to make a new plugin based on an existing plugin.

This folder contains clone project (version 0.7).  The only files installed are those listed below.
