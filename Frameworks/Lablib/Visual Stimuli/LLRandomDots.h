...
@property (NS_NONATOMIC_IOSONLY) float density;
...
@property (NS_NONATOMIC_IOSONLY) float dotContrast;
@property (NS_NONATOMIC_IOSONLY, readonly) RandomDots *dotsData;
@property (NS_NONATOMIC_IOSONLY) float dotDiameterDeg;
- (void)drawCircularStencil;
- (void)drawFrame:(long)frame;
- (void)dumpFrame:(long)frame;
@property (NS_NONATOMIC_IOSONLY) long lifeFrames;
- (void)loadDots:(RandomDots *)pDots;
- (void)makeMovie:(long)durationMS;
- (void)makeMovieFrames:(long)frames;
@property (NS_NONATOMIC_IOSONLY, readonly) long movieFrames;
@property (NS_NONATOMIC_IOSONLY) long randomSeed;
- (void)restore;
...
- (void)store;
@property (NS_NONATOMIC_IOSONLY, readonly) long version;
