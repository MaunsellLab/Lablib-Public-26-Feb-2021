...
// Provide convenient access to keys declared in LLVisualStimulus
        ...
        [keys addObjectsFromArray:@[LLGaborAchromaticKey, LLGaborContrastKey,
                ...
                LLGaborTemporalModulationParamKey, LLGaborTemporalPhaseDegKey]];
...
- (void)runSettingsDialog;
{
    if (dialogWindow == nil) {
        ...
        if (taskPrefix != nil) {
            dialogWindow.title = [NSString stringWithFormat:@"%@ Gabor", taskPrefix];
        }
    }
