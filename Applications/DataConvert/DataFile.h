...
@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSString *dataFileName;
...
@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSMutableAttributedString *infoString;
@property (NS_NONATOMIC_IOSONLY, readonly) float lineDescenderPix;
@property (NS_NONATOMIC_IOSONLY, readonly) float lineHeightPix;
